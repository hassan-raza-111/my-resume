...
export default function Page() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-brand-950">Leave Management</h1>
        <p className="text-sm text-brand-600">Leave requests and approvals</p>
      </div>
      <div className="rounded-xl border border-border bg-surface p-8 shadow-sm">
        <div className="flex flex-col items-center justify-center py-12 text-center">
          <div className="rounded-2xl bg-brand-100 p-4">
            <CalendarOff className="h-8 w-8 text-brand-600" />
          </div>
          <h3 className="mt-4 text-lg font-semibold text-brand-900">Leave Management</h3>
