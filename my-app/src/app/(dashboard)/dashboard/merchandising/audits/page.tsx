...
export default function Page() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-brand-950">Shelf Audits</h1>
        <p className="text-sm text-brand-600">Shelf audit records with photos</p>
      </div>
      <div className="rounded-xl border border-border bg-surface p-8 shadow-sm">
        <div className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <h3 className="mt-4 text-lg font-semibold text-brand-900">Shelf Audits</h3>
